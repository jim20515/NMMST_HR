<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_b0201_03.aspx.cs" Inherits="sys_b_b02_p_b0201_03" %>
                            ...
                            <tr>
                                <td>
                                    <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="200px" Style="position: relative" Width="820px">
                                        ...
                                        <asp:RadioButtonList ID="dwQ_type" runat="server" Style="left: 110px; position: absolute; top: 18px" Height="131px">
