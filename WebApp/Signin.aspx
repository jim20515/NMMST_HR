...
<head runat="server">
	<title>國立海洋科技博物館 - 志工執勤刷卡系統</title>
...
<body class="Frame">
	...
	<input id="ButtonOut" accesskey="3" class="B3" onclick="top.location = 'SignPage2.htm';" style="left: 16px; position: absolute; top: 16px; font-family:微軟正黑體; width: 9%; height: 40px;" tabindex="-1" type="button" value="前去訓練頁" />
	<div>
	<!-- 整頁區域 Start -->
								...
								<tr>
									<td style="width: 800px">
										...
										<table cellspacing="0" cellpadding="0" width="790" border="0">
											<tr style="background-color: #FFFFFF; background-image: url(proj_img/Sign.jpg);">
														...
														<tr>
															...
															<td align="center" style="width: 394px" valign="middle">
																<asp:Panel ID="dwI" runat="server" Height="100%" Style="position: relative" Width="100%">
																	...
																	<input id="bt_SignIn" accesskey="1" class="B1" onclick="uf_click(1);" style="left: 0px; position: absolute; top: 230px; font-family:微軟正黑體" tabindex="-1" type="button" value="上班" />
