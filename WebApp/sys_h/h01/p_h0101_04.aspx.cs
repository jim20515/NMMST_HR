...
public partial class sys_h_h01_p_h0101_04 : p_hrBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            if (this.Request["ReturnObjectID1"] != null)
                ViewState["ReturnObjectID1"] = this.Request["ReturnObjectID1"].Trim();
            else
                ViewState["ReturnObjectID1"] = "";
    ...
    {
        // 只顯示非正式班表
        as_AddSQL += " and IsNull(hmc101_phnom , '') <> '' ";
    ...
    protected void Bt_Conf_Click(object sender, EventArgs e)
    {
        ...
        ls_JavaScript += "	if (opener.document.getElementById(\"" + this.ViewState["ReturnObjectID1"].ToString().Trim() + "\") != null)" + "\r\n";
        ls_JavaScript += "		opener.document.all." + this.ViewState["ReturnObjectID1"].ToString().Trim() + ".value=\"" + ls_name + "\";" + "\r\n";
