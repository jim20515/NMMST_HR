...
public partial class sys_c_c01_p_c0101 : p_sBase
{
	#region ☆ Declare Variables -------------------------------------- 撰寫會員：Linda
	...
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // 增加欄位
        ldt_EmpList.Columns.Add("博物館之友代碼", typeof(String));
        //ldt_EmpList.Columns.Add("會員隊名稱", typeof(String));
        ldt_EmpList.Columns.Add("博物館之友姓名", typeof(String));
        ...
        ldrv_New["博物館之友代碼"] = "F097-00000001";
        //ldrv_New["會員隊名稱"] = "技術會員";
        ldrv_New["博物館之友姓名"] = "王博友";
        ...
        ldrv_New = ldv_EmpList.AddNew();
        ldrv_New["博物館之友代碼"] = "F097-00000002";
        //ldrv_New["會員隊名稱"] = "行政會員";
        ldrv_New["博物館之友姓名"] = "林博友";
        //ldrv_New["支票號碼"] = "0000001";
        //ldrv_New["支票開立日期"] = "097/06/16";
        //ldrv_New["受(繳)款人"] = "XXX工程公司";
        //ldrv_New["支票金額"] = "1,000,000";
