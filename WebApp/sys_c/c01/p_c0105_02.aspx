<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_c0105_02.aspx.cs" Inherits="sys_c_c01_p_c0105_02" %>
                            ...
                            <tr>
                                <td style="height: 108px; width: 605px;">
                                    ...
                                    <witc:DWPanel ID="dwF" runat="server" CssClass="Form" Height="339px" Style="position: relative;
                                        ...
                                        <asp:Label ID="Label21" runat="server" CssClass="N" Style="z-index: 109; left: 308px;
                                            position: absolute; top: 30px" Width="80px">*人員屬性：</asp:Label>
                                        &nbsp;&nbsp;
                                        ...
                                        <asp:Label ID="Label13" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 309px; position: absolute; top: 89px" Width="80px">住址電話：</asp:Label>
                                        <asp:Label ID="Label14" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 309px; position: absolute; top: 112px" Width="80px">行動電話：</asp:Label>
                                        &nbsp;
                                        ...
                                        <asp:TextBox ID="TextBox3" runat="server" Style="left: 121px; position: absolute;
                                            top: 30px" Width="117px">王人士</asp:TextBox>
                                        ...
                                        <asp:TextBox ID="TextBox8" runat="server" Style="left: 389px; position: absolute;
                                            top: 62px" Width="117px"></asp:TextBox>
                                        <asp:TextBox ID="TextBox9" runat="server" Style="left: 389px; position: absolute;
                                            top: 85px" Width="117px"></asp:TextBox>
                                        <asp:TextBox ID="TextBox10" runat="server" Style="left: 389px; position: absolute;
                                            top: 110px" Width="117px"></asp:TextBox>
                                        <asp:TextBox ID="TextBox13" runat="server" Style="left: 389px; position: absolute;
                                        ...
                                        <asp:DropDownList ID="DropDownList5" runat="server" Style="left: 389px; position: absolute;
                                            top: 27px" Width="126px">
                                            <asp:ListItem>工程廠商</asp:ListItem>
                                            <asp:ListItem>飼料廠商</asp:ListItem>
                                            <asp:ListItem>水族館老闆</asp:ListItem>
                                            <asp:ListItem>立委</asp:ListItem>
                                            <asp:ListItem>市議員</asp:ListItem>
                                            <asp:ListItem>代表</asp:ListItem>
                                        ...
                                        <asp:Label ID="Label3" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 306px; position: absolute; top: 137px" Width="80px">職稱：</asp:Label>
                                        &nbsp;
