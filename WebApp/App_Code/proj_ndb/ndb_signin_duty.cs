...
/// </summary>
public class ndb_signin_duty : WIT.Template.Project.n_dbbase
{
	private System.Data.OleDb.OleDbCommand oleDbSelectCommand;
	private System.Data.OleDb.OleDbDataAdapter da_SQL_current;

	public ndb_signin_duty(System.ComponentModel.IContainer container)
	{
		container.Add(this);
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		// oleDbSelectCommand
		// 
		this.oleDbSelectCommand.CommandText = "dbo.[usp_signin_duty]";
	...
	protected override void uf_InitializeComponent()
	{
		...
		//this.ds_Data = new d_signin_duty();
		//this.uf_Initialize();
	}
}
