...
public partial class sys_a_p_sample03 : p_sBase
{
    ...
    protected void bt_Query_Click(object sender, EventArgs e)
    {
        ...
        Microsoft.Reporting.WebForms.ReportParameter[] rsparams = new Microsoft.Reporting.WebForms.ReportParameter[4];
        ...
        rsparams[2] = new Microsoft.Reporting.WebForms.ReportParameter("type", DropDownList1.SelectedValue, true);
        rsparams[3] = new Microsoft.Reporting.WebForms.ReportParameter("order", DropDownList2.SelectedValue, true);
