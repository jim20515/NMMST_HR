<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_sample04.aspx.cs" Inherits="sys_a_p_sample04" %>
                    ...
                    <tr>
                        <td>
                            <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="50px" Style="position: relative;
                                ...
                                &nbsp;
                                <asp:Panel ID="dwQ_s07_spdate" runat="server" CssClass="G" Style="z-index: 106; left: 84px;
                                    position: absolute; top: 15px" Width="132px">
                                    <uc1:u_DateSelect_ROC ID="u_Date3" runat="server" />
                                </asp:Panel>
                                <div class="G" style="display: inline; left: 193px; position: absolute; top: 18px;
                                    z-index: 105;">
                                    至</div>
                                <asp:Panel ID="dwQ_s07_epdate" runat="server" CssClass="G" Style="z-index: 109; left: 212px;
                                    position: absolute; top: 16px" Width="132px">
                                    <uc1:u_DateSelect_ROC ID="u_Date4" runat="server" />
                                </asp:Panel>
                                <asp:Button ID="bt_Query" runat="server" CssClass="B" Style="z-index: 114; left: 395px;
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                ...
                                <ServerReport ReportPath="/HDHDM_Reprot/Sample04" ReportServerUrl="http://10.100.1.126/reportserver"
