<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_sample02.aspx.cs" Inherits="sys_a_p_sample02" %>
                        ...
                        <td>
                            <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="50px" Style="position: relative;
                                ...
                                <asp:Label ID="dwQ_s07_spdate_t" runat="server" CssClass="Q" Style="z-index: 105;
                                    left: 4px; position: absolute; top: 18px" Width="40px">從</asp:Label>
                                <asp:Label ID="Label1" runat="server" CssClass="Q" Style="z-index: 105; left: 364px;
                                    position: absolute; top: 18px" Width="40px">種類：</asp:Label>
                                ...
                                <div class="G" style="display: inline; left: 157px; position: absolute; top: 18px;
                                    z-index: 105;">
                                    至</div>
                                ...
                                <asp:Button ID="bt_Query" runat="server" CssClass="B" Style="z-index: 114; left: 552px;
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                ...
                                <ServerReport ReportPath="/HDHDM_Reprot/Sample02" ReportServerUrl="http://10.100.1.126/reportserver"
