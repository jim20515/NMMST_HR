...
public partial class sys_a_a02_p_a0212_01 : p_hrBase
{
	...
	{
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hca212, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hca212, null);
		this.dgG_Sort = "hca212_sort";
	}
	...
	{
		this.uf_AddJavaScript("uf_LinkFrame('p_a0212_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "')");
	}
