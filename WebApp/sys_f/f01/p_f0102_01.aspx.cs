...
public partial class sys_f_f01_p_f0102_01 : p_hrBase
{
    ...
    {
        this.uf_AddJavaScript("uf_LinkFrame('p_f0102_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_f0102_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[5].Text.Trim() + "'); uf_LinkFrame('p_f0102_04.aspx', '04Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "');");
	}
