...
public partial class sys_f_f01_p_f0101_01 : p_hrBase
{
    ...
    {
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hmf101, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hmf101, null);
    ...
    {
		this.uf_AddJavaScript("uf_LinkFrame('p_f0101_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "')");
	}
