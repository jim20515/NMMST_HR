<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_f0102_01.aspx.cs" Inherits="sys_f_f01_p_f0102_01" %>
                ...
                <div>
                    <asp:Panel ID="pn_Contain" runat="server">
                        <table class="G">
                            <tr>
                                <td>
                                    <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="73px" Style="position: relative" Width="820px">
                                        ...
                                        <asp:Button ID="bt_Query" runat="server" CssClass="Bt_Search" Style="z-index: 999; left: 725px; position: absolute; top: 36px" Text="" Width="80px" />
                                    </witc:DWPanel>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="272px" Width="820px">
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyField="hmf102_trainid" DataMember="hmf102" DataSource="<%# indb_hmf102.dv_View %>" Width="800px">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="hmf102_starttime" HeaderText="開始時間" SortExpression="hmf102_starttime"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="hmf102_endtime" HeaderText="結束時間" SortExpression="hmf102_endtime"></asp:BoundColumn>--%>
                                                <asp:TemplateColumn HeaderText="開課地點">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_hmf102_placeid" runat="server" Text='<%# uf_Dg_Bind("hca209", DataBinder.Eval(Container, "DataItem.hmf102_placeid")) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="hmf102_maxno" HeaderText="開課人數" SortExpression="hmf102_maxno"></asp:BoundColumn>
                                            </Columns>
                                        </asp:DataGrid>
                                    </witc:ScrollGrid>
                                </td>
