<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_f0202_01.aspx.cs" Inherits="sys_f_f02_p_f0202_01" %>
...
<body>
				...
				<table class="G">
					...
					<tr>
						<td>
							...
							<hr class="G" />
							<br />
							<span class="RH">步驟二：依照 Excel 檔案的工作表「匯入資料格式說明」將資料輸入到工作表「教育訓練刷卡紀錄批次匯入資料」中，</span>
							<br />
					...
					<tr>
						<td>
							...
							<br />
							<span class="RH">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（系統會將 Excel 檔案中所列之基本資料儲存至資料庫《教育訓練刷卡紀錄》中）</span>
							<br />
	...
	<script language="JavaScript" src="j_f0202_01.js" type="text/javascript"></script>
