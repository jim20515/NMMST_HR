<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_g0101_01.aspx.cs" Inherits="sys_g_g01_p_g0101_01" %>
				...
				<tr>
					<td>
						<witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="103px" Style="position: relative" Width="820px">
							...
							<asp:DropDownList ID="dwQ_hmg101a_ktype" runat="server" Style="z-index: 100; left:104px; position: absolute; top:8px" Width="200px" CssClass="B"> <asp:ListItem Value="">《全部》</asp:ListItem> 							    <asp:ListItem Value="1">實習志工考核</asp:ListItem>
							...
							<asp:DropDownList ID="dwQ_hmg101a_syear" runat="server" Style="z-index: 105; left:508px; position: absolute; top:8px" Width="200px" CssClass="B" DataMember="YY_dc"></asp:DropDownList>
							...
							<asp:DropDownList ID="dwQ_hmg101a_sseason" runat="server" Style="z-index: 110; left:104px; position: absolute; top:34px" Width="200px" CssClass="B"> <asp:ListItem Value="">《全部》</asp:ListItem> 							    <asp:ListItem Value="0">-</asp:ListItem>
