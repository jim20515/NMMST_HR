...
public partial class sys_g_g01_p_g0101_01 : p_hrBase
{
    ...
    {
        this.uf_AddJavaScript("uf_LinkFrame('p_g0101_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_g0101_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "') ;");
	}
