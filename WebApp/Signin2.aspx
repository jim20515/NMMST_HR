...
<head runat="server">
	<title>國立海洋科技博物館 - 志工訓練刷卡系統</title>
	<link href="proj_css/s_GeneralStyle.css" type="text/css" rel="stylesheet" />
	<script language="JavaScript" src="j_Signin.js" type="text/javascript"></script>
	<style type="text/css">
...
<body class="Frame">
	...
	<input id="ButtonOut" accesskey="3" class="B3" onclick="top.location = 'SignPage.htm';" style="left: 16px; position: absolute; top: 16px; font-family:微軟正黑體; width: 9%; height: 40px;" tabindex="-1" type="button" value="前去執勤頁" />
								...
								<tr>
									<td style="width: 800px">
										...
										<table cellspacing="0" cellpadding="0" width="790" border="0">
											<tr style="background-color: #FFFFFF; background-image: url(proj_img/Sign2.jpg);">
												<td align="right" style=" height: 150px; background-repeat: no-repeat">
													<table cellpadding="0" cellspacing="0" style="height: 100%" width="280">
														<tr>
															<td align="center">
																<asp:Label ID="lb_ShowDate" runat="server" Font-Bold="True" Font-Size="40pt" ForeColor="#000000" Text="0000/00/00"></asp:Label></td>
														</tr>
														<tr>
															<td align="center" valign="top">
                                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                    <ContentTemplate>  
																<asp:Label ID="lb_ShowTime" runat="server" Font-Bold="True" Font-Size="40pt" ForeColor="#000000" Text="00:00:00" Height="59px" Width="196px"></asp:Label>
                                                                <asp:Label ID="lb_realtime" runat="server" ForeColor="#F0F0FF" Style="z-index: 100; left: 5000px; position: absolute; top: 0px "   Width="0px"></asp:Label>
                                                                    </ContentTemplate> 
                                                                </asp:UpdatePanel> 
                                                            </td>
														</tr>
											...
											<tr>
												<td align="right" style="background-color: #EACE10">
													<table cellpadding="0" cellspacing="0" style="height: 300px" width="790">
														<tr>
															<td valign="middle" align="center" style="background-color: #EACE10">
															...
															<td align="center" style="width: 394px" valign="middle">
																<asp:Panel ID="dwI" runat="server" Height="100%" Style="position: relative" Width="100%">
																	<div style="left: 0px; position: absolute; top: 0px; width: 100%; height: 230px">
																		<div id="view0" style="padding-top: 180px; width: 100%; height: 100%; background-color: #EACE10; font-size: 20pt; color: #3030A0; font-family:微軟正黑體">
																			<b>↓請先選擇《上課》或《下課》</b>
																		</div>
																		<div id="view1" class="V1" style="display: none" onclick="return view1_onclick()">
                                                                            歡迎！<br />
																			【刷<span style="color: blue; font-weight: bold">上課</span>卡】&nbsp;&nbsp;&nbsp;&nbsp; <img src="proj_img/checkin.png" alt="X" />
																			<asp:UpdatePanel ID="UpdatePanel3" runat="server">
																				<ContentTemplate>
																			<asp:TextBox ID="tbx_SignIn" runat="server" AutoPostBack="True" CssClass="TG" OnTextChanged="tbx_SignIn_TextChanged" TextMode="Password"></asp:TextBox>
																				</contenttemplate>
																			</asp:UpdatePanel>
																		...
																		<div id="view2" class="V2" style="display: none">
                                                                            辛苦了！<br />
																			【刷<span style="color: blue; font-weight: bold">下課</span>卡】&nbsp;&nbsp;&nbsp;&nbsp; <img src="proj_img/checkout.png" alt="X" />
																	...
																	<input id="bt_SignIn" accesskey="1" class="B1" onclick="uf_click(1);" style="left: 0px; position: absolute; top: 230px; font-family:微軟正黑體" tabindex="-1" type="button" value="上課" />
																	<input id="bt_SignOut" accesskey="2" class="B2" onclick="uf_click(2);" style="left: 197px; position: absolute; top: 230px; font-family:微軟正黑體" tabindex="-1" type="button" value="下課" />
