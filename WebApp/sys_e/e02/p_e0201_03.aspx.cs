...
public partial class sys_e_e02_p_e0201_03 : p_hrBase
{
    ...
    {
        //this.uf_AddJavaScript("uf_LinkFrame('p_e0201_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_e0101_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[3].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[4].Text.Trim() + "')");
        ...
        ls_name = dgG.Items[dgG.SelectedIndex].Cells[3].Text.Trim();
