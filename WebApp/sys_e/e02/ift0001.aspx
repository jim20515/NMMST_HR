<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ift0001.aspx.cs" Inherits="sys_e_e02_p_e0201_02" %>
                            ...
                            <tr>
                                <td>
                                    <witc:DWPanel ID="dwF" runat="server" CssClass="Form" Height="200px" Style="position: relative" Width="820px">
                                        ...
                                        <asp:Label ID="dwF_hle201_ip_t" runat="server" CssClass="N" Style="z-index: 114; left: 25px; position: absolute; top: 94px" Width="100px">刷卡機IP：</asp:Label>
