<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_e0101_01.aspx.cs" Inherits="sys_e_e01_p_e0101_01" %>
                                    ...
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="272px" Width="820px">
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyField="hme101a_psid" DataMember="hme101a" DataSource="<%# indb_hme101a.dv_View %>" Width="800px">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="hme101a_hrneedno" HeaderText="志工排班次數" SortExpression="hme101a_hrneedno">
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                </asp:BoundColumn>
												...
												<asp:TemplateColumn HeaderText="是否允許其他小隊報名">
													<ItemTemplate>
														<asp:Label ID="dwG_hme101a_openflag" runat="server" Text='<%# uf_Dg_BindBool("是,否", uf_Dg_BindBool("Y", DataBinder.Eval(Container, "DataItem.hme101a_openflag"))) %>'></asp:Label>
													</ItemTemplate>
													<ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
												</asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="是否為正式班表">
                                                    <ItemTemplate>
