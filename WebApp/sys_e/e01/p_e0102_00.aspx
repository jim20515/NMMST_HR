<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_e0102_00.aspx.cs" Inherits="sys_e_e01_p_e0102_00" %>
            ...
            <ContentTemplate>
                <div>
                    <asp:Panel ID="pn_Contain" runat="server" Height="488px">
                        <table class="G">
                            <tr>
                                <td style="height: 59px; width: 602px;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="dw_show" runat="server" ForeColor="Purple" Style="left: 0px; position: relative; top: 0px;">◎查詢結果</asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="272px" Width="820px">
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyField="hme101a_psid" DataMember="hme101a" DataSource="<%# indb_hme101a.dv_View %>" Width="770px">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="是否開放">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_hme101a_makeflag" runat="server" Text='<%# uf_Dg_BindBool("是,否", uf_Dg_BindBool("Y", DataBinder.Eval(Container, "DataItem.hme101a_makeflag"))) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="需求班次">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="不足班次">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_rcount1_c" runat="server" Text='<%# e01Project.uf_rcount_short( DataBinder.Eval(Container, "DataItem.hme101a_psid")) %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="過多班次">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_rcount2_c" runat="server" Text='<%# e01Project.uf_rcount_more( DataBinder.Eval(Container, "DataItem.hme101a_psid")) %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="滿足班次">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_rcount3_c" runat="server" Text='<%# e01Project.uf_rcount_satisfy( DataBinder.Eval(Container, "DataItem.hme101a_psid")) %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="需求人次">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="已排人次">
                                                    <ItemTemplate>
                                                        <asp:Label ID="dwG_pcount_actual_c" runat="server" Text='<%# e01Project.uf_pcount_actual( DataBinder.Eval(Container, "DataItem.hme101a_psid")) %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                                </asp:TemplateColumn>
