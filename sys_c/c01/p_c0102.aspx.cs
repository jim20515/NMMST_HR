...
public partial class sys_c_c01_p_c0102 : p_sBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // 增加欄位
        ldt_EmpList.Columns.Add("會員代碼", typeof(String));
        //ldt_EmpList.Columns.Add("會員隊名稱", typeof(String));
        ldt_EmpList.Columns.Add("會員姓名", typeof(String));
