<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_c0102.aspx.cs" Inherits="sys_c_c01_p_c0102" %>
                                ...
                                <td style="height: 35px; width: 604px;">
                                    <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="38px" Style="position: relative;
                                        ...
                                        <asp:Label ID="dwQ_aec02_code_t" runat="server" CssClass="D" Style="z-index: 101;
                                            left: 7px; position: absolute; top: 10px" Width="80px" ForeColor="Blue">會員代碼：</asp:Label>
                                        <asp:Label ID="Label1" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 101;
                                            left: 282px; position: absolute; top: 10px" Width="80px">會員姓名：</asp:Label>
                                ...
                                <td style="height: 108px; width: 604px;">
                                    ...
                                    <witc:DWPanel ID="dwF" runat="server" CssClass="Form" Height="339px" Style="position: relative;
                                        ...
                                        <asp:Label ID="dwF_aec02_name_t" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 326px; position: absolute; top: 7px" Width="80px">會員帳號：</asp:Label>
                                        <asp:Label ID="Label7" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 37px; position: absolute; top: 7px" Width="80px">會員代碼：</asp:Label>
                                        <asp:Label ID="Label19" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 121px; position: absolute; top: 7px; text-align: left" Width="118px">M097-00000001</asp:Label>
                                        ...
                                        <asp:TextBox ID="TextBox3" runat="server" Style="left: 121px; position: absolute;
                                            top: 30px" Width="117px">陳亞倫</asp:TextBox>
                                        <asp:TextBox ID="TextBox13" runat="server" Style="left: 406px; position: absolute;
                                            top: 4px" Width="117px">alanchen</asp:TextBox>
                                        ...
                                        <asp:TextBox ID="TextBox11" runat="server" Font-Bold="True" Height="35px" Style="left: 118px;
                                            position: absolute; top: 238px" Width="277px"></asp:TextBox>
                                        &nbsp;
                                        ...
                                        <asp:Button ID="Button4" runat="server" Style="left: 536px; position: absolute; top: 4px"
                                            Text="變更" />
                                        <asp:Label ID="Label20" runat="server" CssClass="D" ForeColor="Blue" Style="z-index: 109;
                                            left: 326px; position: absolute; top: 35px" Width="80px">會員密碼：</asp:Label>
                                        <asp:TextBox ID="TextBox14" runat="server" Style="left: 406px; position: absolute;
                                            top: 32px" Width="117px">*******</asp:TextBox>
                                        <asp:Button ID="Button6" runat="server" Style="left: 536px; position: absolute; top: 32px"
                                            Text="變更" />
                                        ...
                                        <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal"
                                            Style="left: 36px; position: absolute; top: 286px" Width="257px">
                                            <asp:ListItem>是否通過認證</asp:ListItem>
                                            <asp:ListItem>是否訂閱電子報</asp:ListItem>
                                        </asp:CheckBoxList>
                                    ...
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="150px" Width="800px"
										...
										<ItemTemplate>
											<asp:Checkbox ID="dwG_CHECK" runat="server" CausesValidation="False" >
                                                ...
                                                <asp:BoundColumn DataField="會員代碼" HeaderText="會員代碼" SortExpression="會員代碼"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="會員姓名" HeaderText="會員姓名" SortExpression="會員姓名"></asp:BoundColumn>
