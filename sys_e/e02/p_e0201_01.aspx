                            ...
                            <tr>
                                <td>
                                    <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="70px" Style="position: relative" Width="820px">
                                        ...
                                        <asp:Label ID="dwQ_hle201_vid_t" runat="server" CssClass="Q" Style="z-index: 99; left: 4px; position: absolute; top: 41px" Width="100px">志工代碼：</asp:Label>
                                        <asp:Label ID="dwQ_hle201_tid_t" runat="server" CssClass="Q" Style="z-index: 99; left: 377px; position: absolute; top: 10px" Width="100px">志工隊：</asp:Label>
                                        <asp:DropDownList ID="dwQ_hle201_tid" runat="server" CssClass="G" DataMember="hmd101" Style="left: 479px; position: absolute; top: 7px">
                                        </asp:DropDownList>
                                        <asp:Label ID="dwQ_hle201_vname_t" runat="server" CssClass="Q" Style="z-index: 99; left: 377px; position: absolute; top: 41px" Width="100px">志工姓名：</asp:Label>
                                        ...
                                        <asp:Label ID="dwQ_hle201_sdatetime_s_t" runat="server" CssClass="Q" Style="z-index: 104; left: 4px; position: absolute; top: 10px" Width="100px">刷卡日期：</asp:Label>
                                    ...
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="272px" Width="820px">
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyField="hle201_lid" DataMember="hle201" DataSource="<%# indb_hle201.dv_View %>" Width="785px">
                                            ...
                                            <Columns>
                                                ...
                                                <%--                  <asp:BoundColumn DataField="hle201_vid" HeaderText="志工代碼" SortExpression="hle201_vid">
