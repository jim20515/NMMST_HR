<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_e0102_02.aspx.cs" Inherits="sys_e_e01_p_e0102_02" %>
                            ...
                            <tr>
                                <td>
                                    <witc:DWPanel ID="dwS" runat="server" CssClass="Form" Height="300px" Style="position: relative" Width="820px">
                                        ...
                                        <%--<asp:Label ID="Label7" runat="server" ForeColor="Blue" Height="19px" Style="left: 517px; position: relative; top: 53px">隊員姓名：</asp:Label>
                                        <asp:TextBox ID="TextBox1" CssClass="G" runat="server" Style="left: 710px; position: absolute; top: 50px" Width="100px"></asp:TextBox>
                                        <asp:Button ID="bt_search" runat="server" Style="left: 736px; position: absolute; top: 76px" Width="80px" OnClick="bt_search_Click" CssClass="Bt_Search" />--%>
