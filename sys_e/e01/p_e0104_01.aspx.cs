// *********************************************************************************
// 1. 程式描述：服務勤務管理–排班管理–臨時排班調整–查詢及清單
// 2. 撰寫人員：demon
// *********************************************************************************
using System;
using System.Data;
...
public partial class sys_e_e01_p_e0104_01 : p_hrBase
{
    ...
    {
        this.uf_AddJavaScript("uf_LinkFrame('p_e0104_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[3].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[4].Text.Trim() + "')");
	}
    ...
    {
        // 只顯示非正式班表
        as_AddSQL += " and hme101a_okflag = 'Y'";
