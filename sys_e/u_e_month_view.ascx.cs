        ...
        if (this.indb_hme105a_hme105b.uf_RowCount() > 0)
        {
            ...
            for (int li_row = 0; li_row < this.indb_hme105a_hme105b.uf_RowCount(); li_row++)
            {
                ...
                if (this.ReadOnly == "False")
                {
                    ...
                    litr_Change.Text = (llb_day.Text.EndsWith("...</SPAN></FONT>") ? "" : "&nbsp;") + "<A tabindex=\"-1\" href=\"javascript:__doPostBack('" + lbt_Change.Parent.ClientID + "$lbt_Change','4|" + this.indb_hme105a_hme105b[li_row]["hme105b_sdid"].ToString() + "')\"><IMG border=\"0\" src=\"" + this.Request.ApplicationPath + "/proj_img/Edit.gif\" align=\"absmiddle\" style=\"cursor=hand\" title=\"編輯\"></A>";
