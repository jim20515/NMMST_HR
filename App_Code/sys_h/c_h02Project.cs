	...
	public class h02Project
	{
		...
		static public string uf_Get_SystemNo(string as_nokind, string as_startswith)
		{
			...
			switch (as_nokind.ToLower())
			{
                 ...
                 //註解：
                 case "hmh200.hmh200_cmid":

                 	li_flen = as_startswith.Length;
                 	li_len = 5;
                 	ls_sql = "SELECT CAST(IsNull(Max(Cast(Right(hmh200_cmid,5) as int)), '0') as varchar(5)) FROM hmh200 ";
                 	
                 	break;


                 //註解：
                 case "hmh201a.hmh201a_cid":

                 	li_flen = as_startswith.Length;
                 	li_len = 5;
                 	ls_sql = "SELECT CAST(IsNull(Max(Cast(Right(hmh201a_cid,5) as int)), '0') as varchar(5)) FROM hmh201a ";
