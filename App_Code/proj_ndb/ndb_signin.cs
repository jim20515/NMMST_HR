...
public class ndb_signin : WIT.Template.Project.n_dbbase
{
	...
	private void InitializeComponent()
	{
		...
		// oleDbSelectCommand
		// 
		this.oleDbSelectCommand.CommandText = "dbo.[usp_signin]";
		this.oleDbSelectCommand.CommandType = System.Data.CommandType.StoredProcedure;
		this.oleDbSelectCommand.Connection = this.cn_DB;
		this.oleDbSelectCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("as_empno", System.Data.OleDb.OleDbType.VarChar, 8));
