...
public partial class sys_f_f01_p_f0101A_01 : p_hrBase
{
    ...
    {
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hmf101a, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hmf101a, null);
    ...
    {
        this.uf_AddJavaScript("uf_LinkFrame('p_f0101A_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_f0101A_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "')");
	}
