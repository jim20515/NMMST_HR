...
public partial class sys_f_f01_p_f0101A : p_sBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // 增加欄位
        ldt_emp1List.Columns.Add("認證代碼", typeof(String));
        ldt_emp1List.Columns.Add("認證名稱", typeof(String));
        ldt_emp1List.Columns.Add("課程數", typeof(String));


        ldrv_New = ldv_emp1List.AddNew();
        ldrv_New["認證代碼"] = "01";
        ldrv_New["認證名稱"] = "潮間帶專業認證";
        ldrv_New["課程數"] = "3";
        //ldrv_New["參加別"] = "全部";

        ldrv_New = ldv_emp1List.AddNew();
        ldrv_New["認證代碼"] = "02";
        ldrv_New["認證名稱"] = "海洋生物專業認證";
        ldrv_New["課程數"] = "2";
        //ldrv_New["參加別"] = "技術志工";

        ldrv_New = ldv_emp1List.AddNew();
        ldrv_New["認證代碼"] = "03";
        ldrv_New["認證名稱"] = "海洋植物專業認證";
        ldrv_New["課程數"] = "3";
