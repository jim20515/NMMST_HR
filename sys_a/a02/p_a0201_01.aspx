	...
	<form id="form1" runat="server">
		...
		<asp:Panel ID="pn_Contain" runat="server">
			<table class="G">
				<tr>
					<td>
						<witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="77px" Style="position: relative" Width="820px">
							<asp:Label ID="dwQ_hca201_id_t" runat="server" CssClass="Q" Style="z-index: 99; left:4px; position: absolute; top:12px" Width="100px">類別代碼：</asp:Label>
							...
							<asp:Label ID="dwQ_hca201_name_t" runat="server" CssClass="Q" Style="z-index: 104; left:408px; position: absolute; top:12px" Width="100px">類別名稱：</asp:Label>
				...
				<asp:BoundColumn DataField="hca201_id" HeaderText="類別代碼" SortExpression="hca201_id"></asp:BoundColumn>
				<asp:BoundColumn DataField="hca201_name" HeaderText="類別名稱" SortExpression="hca201_name"></asp:BoundColumn>
				<asp:TemplateColumn HeaderText="是否停用">
				    <ItemTemplate>
				         <asp:Label ID="dwG_hca201_stop" runat="server" Text='<%# uf_Dg_BindBool("是,否", uf_Dg_BindBool("Y", DataBinder.Eval(Container, "DataItem.hca201_stop"))) %>'></asp:Label>
				    </ItemTemplate>
				</asp:TemplateColumn>
