...
public partial class sys_a_a02_p_a0210_01 : p_hrBase
{
    ...
    {
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hca210, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hca210, null);
    ...
    {
		this.uf_AddJavaScript("uf_LinkFrame('p_a0210_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "')");
	}
