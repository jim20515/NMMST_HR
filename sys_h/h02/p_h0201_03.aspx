<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_h0201_03.aspx.cs" Inherits="sys_h_h02_p_h0201_03" %>
                        ...
                        <table class="G">
                            ...
                            <tr>
                                <td style="height: 4px">
                                    ...
                                    <asp:Label ID="show_t" Style="left: 51px; position: relative" runat="server" CssClass="N">※ 查詢清單只列出已填寫E-Mail的人員清單 </asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="290px" Width="620px">
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyField="hmc101_id" DataMember="hmc101" DataSource="<%# indb_hmc101.dv_View %>" Width="592px">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="hmc101_email" HeaderText="E-Mail"></asp:BoundColumn>
                                            </Columns>
                                        </asp:DataGrid>
                                    </witc:ScrollGrid>
                                </td>
