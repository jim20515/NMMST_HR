...
public partial class sys_h_h02_p_h0200_02 : p_hrBase
{
    ...
    {
		// 初始化
		this.uf_InitializeQuery(null, this.indb_hmh200, null);
		this.uf_InitializeComponent(dwF, null, this.indb_hmh200, u_Edit_F);
	...
	private bool u_Edit_F_PreEndEdit(Control adwF, n_dbbase andb_Data, DataRow adr_Row, DataRowView adrv_Row)
	{
		...
		if (adrv_Row.IsNew)
		{
			...
			// 取得流水號的系統編號–資料庫最大值+1
			adrv_Row["hmh200_cmid"] = h02Project.uf_Get_SystemNo("hmh200.hmh200_cmid", "CM" + NY + "-");
			dwF_hmh200_cmid.Text = adrv_Row["hmh200_cmid"].ToString();
	...
	{
        //Image1.ImageUrl = dwF_hmh200_picurl ;
        ImageX.ImageUrl = dwF_hmh200_picurl.Text; 
        return true;
	}
