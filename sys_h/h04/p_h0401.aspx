<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_h0401.aspx.cs" Inherits="sys_h_h02_p_h0401" %>
				...
				<tr>
					<td>
						<witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="84px" Style="position: relative" Width="800px">
							<asp:Label ID="dwQ_s07_unit_t" runat="server" CssClass="Q" Style="z-index: 101; left: 4px; position: absolute; top: 12px" Width="80px">公告對象：</asp:Label>
							<asp:DropDownList ID="dwQ_s07_unit" runat="server" CssClass="G" DataMember="para20" Style="z-index: 102; left: 88px; position: absolute; top: 8px" Width="200px"></asp:DropDownList>
							...
							<asp:Button ID="bt_Query" runat="server" CssClass="B" Style="z-index: 114; left: 536px; position: absolute; top: 8px" Text="查詢" Width="56px" />
						</witc:DWPanel>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<witc:DWPanel ID="dwF" runat="server" CssClass="Form" Height="228px" Style="position: relative" Width="800px">
							...
							<asp:Label ID="dwF_s07_unit_t" runat="server" CssClass="I" Style="z-index: 105; left: 4px; position: absolute; top: 36px" Width="80px">公告對象：</asp:Label>
							<asp:DropDownList ID="dwF_s07_unit" runat="server" CssClass="G" DataMember="para20" Style="z-index: 106; left: 88px; position: absolute; top: 32px" Width="200px"></asp:DropDownList>
