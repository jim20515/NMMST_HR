...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'usp_signin_class' 
	   AND 	  type = 'P')
    DROP PROCEDURE usp_signin_class
GO

CREATE PROCEDURE usp_signin_class(@as_empno char(9), @as_type char(1), @as_ip char(15))
...
--EXEC dbo.usp_signin_class '098010017', '2', '10.100.1.15'
--EXEC dbo.usp_signin_class '00052162', '2', '10.100.1.15'
--EXEC dbo.usp_signin_class '00052788', '1', '10.100.1.15'
--EXEC dbo.usp_signin_class '00052788', '2', '10.100.1.15'
--EXEC dbo.usp_signin_class '00051888', '1', '10.100.1.15'
--EXEC dbo.usp_signin_class '10011914', '1', '10.100.1.15'
GO
