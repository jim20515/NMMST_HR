...
public partial class sys_i_i01_p_i0103 : p_sBase
{
	#region ☆ Declare Variables -------------------------------------- 撰寫會員：Emily

	/// <summary>變數描述：公告管理資料元件</summary>
    protected ndb_hmi103 indb_hmi103 = new ndb_hmi103();
    ...
    {
        this.uf_InitializeQuery(dwQ, this.indb_hmi103, bt_Query);
        this.uf_InitializeComponent(dwF, dgG, this.indb_hmi103, null);
    ...
    //{
    //     //重新繫結群組資料
    //    dwF_hmi103_select.DataBind();

    //    // 如果有資料則取出第一筆的群組資料
    //    if (dwF_hmi103_select.Items.Count > 0)
    //    {
    //        dwF_hmi103_select.SelectedIndex = 0;
