...
public partial class sys_d_d01_p_d0100_01 : p_hrBase
{
    ...
    {
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hmd100a, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hmd100a, null);
    ...
    {
        this.uf_AddJavaScript("uf_LinkFrame('p_d0100_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_d0100_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[3].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[6].Text.Trim()  + "');");
	}
	...
	/// 事件描述：繫結志工隊資料
	/// </summary>
	protected string uf_lvid_name(object ao_id)
	{
		string ls_return = "全部";
		if (ao_id.ToString().Trim() != "ALL")
			ls_return = this.uf_Dg_BindFind("hmd101",ao_id.ToString().Trim());
		return ls_return;
	}
