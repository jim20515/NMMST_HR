...
public partial class sys_d_d01_p_d0100 : p_sBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //// 增加欄位
        //ldt_EmpList.Columns.Add("志工隊代碼", typeof(String));
    ...
    {
        Button4.Attributes["OnClick"] = "window.open('p_d0101_new_01.aspx','','top=140,left=90,height=320,width=620,location=no','')";
    }
    protected void Button6_Click(object sender, EventArgs e)
    {
        Button6.Attributes["OnClick"] = "window.open('p_d0101_new_02.aspx','','top=140,left=90,height=320,width=620,location=no','')";
    }
