<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p_d0101_new_01.aspx.cs" Inherits="sys_d_d01_p_d0101_new_01" %>
                                ...
                                <td style="height: 64px; width: 607px;">
                                    <witc:DWPanel ID="dwQ" runat="server" CssClass="Query" Height="60px" Style="position: relative;
                                        ...
                                        <asp:Label ID="dwF_ema11_ybar_t" runat="server" CssClass="I" Style="z-index: 105;
                                            left: 26px; position: absolute; top: 23px" Width="100px">員工代號：</asp:Label>
                                        ...
                                        <asp:Label ID="dwF_ema11_code_amt_t" runat="server" CssClass="I" Style="z-index: 113;
                                            left: 238px; position: absolute; top: 23px" Width="68px">員工姓名：</asp:Label>
                                ...
                                <td style="width: 607px">
                                    <witc:ScrollGrid ID="dwG" runat="server" CssClass="Grid" Height="200px" Width="800px"
                                        ...
                                        <asp:DataGrid ID="dgG" runat="server" AutoGenerateColumns="False" CssClass="Grid"
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderText="員工代號">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" CommandName="Select" Text='<%# DataBinder.Eval(Container, "DataItem.員工代號") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="員工姓名" HeaderText="員工姓名" SortExpression="員工姓名稱"></asp:BoundColumn>
                                            </Columns>
                                        </asp:DataGrid>
                                    </witc:ScrollGrid>
                                </td>
