...
public partial class sys_d_d01_p_d0102_01 : p_hrBase
{
	...
	{
		// 初始化
		this.uf_InitializeQuery(dwQ, this.indb_hmd102, bt_Query);
		this.uf_InitializeComponent(null, dgG, this.indb_hmd102, null);
	...
	{
		this.uf_AddJavaScript("uf_LinkFrame('p_d0102_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "|" + dgG.Items[dgG.SelectedIndex].Cells[2].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[3].Text.Trim() + "|" + dgG.Items[dgG.SelectedIndex].Cells[4].Text.Trim() + "');");
	}
