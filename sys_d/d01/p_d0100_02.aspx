				...
				<tr>
					<td>
						<witc:DWPanel ID="dwF" runat="server" CssClass="Form" Height="285px" Style="position: relative" Width="820px">
							<asp:Label ID="dwF_hmd100a_posid_t" runat="server" CssClass="D" Style="z-index:99; left:4px; position: absolute; top:8px" Width="100px">職位代碼：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_posname_t" runat="server" CssClass="N" Style="z-index:104; left:4px; position: absolute; top:34px" Width="100px">職位名稱：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_belon_t" runat="server" CssClass="I" Style="z-index:109; left:4px; position: absolute; top:60px" Width="100px">編制來源：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_poslv_t" runat="server" CssClass="N" Style="z-index:114; left:4px; position: absolute; top:86px" Width="100px">職位位置：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_posno_t" runat="server" CssClass="N" Style="z-index:119; left:4px; position: absolute; top:112px" Width="100px">職位人數：</asp:Label>
							...
							<asp:CheckBox ID="dwF_hmd100a_stop" runat="server" Style="z-index:125; left:104px; position: absolute; top: 138px" Text="停用" />
							<asp:Label ID="dwF_hmd100a_aid_t" runat="server" CssClass="D" Style="z-index:129; left:4px; position: absolute; top:164px" Width="100px">新增人員：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_adt_t" runat="server" CssClass="D" Style="z-index:134; left:4px; position: absolute; top:190px" Width="100px">新增時間：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_uid_t" runat="server" CssClass="D" Style="z-index:139; left:4px; position: absolute; top:216px" Width="100px">異動人員：</asp:Label>
							...
							<asp:Label ID="dwF_hmd100a_udt_t" runat="server" CssClass="D" Style="z-index:144; left:4px; position: absolute; top:242px" Width="100px">異動時間：</asp:Label>
