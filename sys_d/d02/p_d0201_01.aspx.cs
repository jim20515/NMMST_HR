...
public partial class sys_d_d02_p_d0201_01 : p_hrBase
{
    ...
    {
		this.uf_AddJavaScript("uf_LinkFrame('p_d0201_03.aspx', '03Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_d0201_04.aspx', '04Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_d0201_05.aspx', '05Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_LinkFrame('p_d0201_06.aspx', '06Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "');uf_LinkFrame('p_d0201_02.aspx', '02Frame', '" + dgG.DataKeys[dgG.SelectedIndex].ToString() + "'); uf_SelectFrame(2,'no'); ");
    }
    ...
    protected void bt_Import_Click(object sender, System.EventArgs e)
    {
        //this.uf_Msg("班表志願名單編輯完成！");
        this.uf_AddJavaScript("window.open('choosexls.aspx');");
    }
}
